...
export const metadata: Metadata = {
  title: "Obrigado - Café Canastra Atacado",
  description: "Obrigado pelo seu contato! Em breve retornaremos.",
}

export default function ObrigadoAtacadoPage() {
  return (
    <>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex flex-col space-y-4">
                ...
                >
                  <a href="https://wa.me/553497308171?text=Ol%C3%A1%2C%20gostaria%20de%20conversar%20com%20o%20supervisor%20de%20vendas" target="_blank" rel="noopener noreferrer">
