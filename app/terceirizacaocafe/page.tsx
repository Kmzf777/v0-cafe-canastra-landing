          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
              {[
                {
                  icon: Coffee,
                  title: "Café 100% Arábica Especial",
                  desc: "Grãos selecionados da Serra da Canastra",
                },
                {
                  icon: Package,
                  title: "Design Incluído",
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <Card className="overflow-hidden hover:shadow-2xl transition-all duration-500 bg-white border-0 rounded-3xl group shadow-lg hover:shadow-orange-200/50 transform hover:-translate-y-2">
                <div className="h-64 relative overflow-hidden">
                  <Image
                    src="/images/drip-coffee-produto.png"
                    alt="Drip Coffee personalizado"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-300"
                  />
                </div>
                <CardContent className="p-8">
                  <h3 className="text-3xl font-bold text-gray-800 mb-4">Drip Coffee</h3>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Café coado individual. Praticidade e experiência premium em qualquer lugar, com a sua marca.
                  </p>
                  <Button
                    className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white py-3 rounded-full group"
                    onClick={scrollToForm}
              ...
              {[
                {
                  ...
                  answer:
                    "Sim! Trabalhamos tanto com nossos grãos especiais quanto com grãos fornecidos pelo cliente, sempre mantendo nossa qualidade de torra excepcional.",
                },
                {
                  question: "Vocês fazem só a torra?",
                  answer:
                    "Sim. Caso você necessite apenas o serviço de torra, executamos e enviamos para que você. Também oferecemos o serviço completo: desde o design da embalagem, torra personalizada, empacotamento até a entrega. Você pode escolher quais etapas deseja terceirizar.",
                },
                {
